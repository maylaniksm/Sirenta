                ...
                <div className="pr-5 py-8">
                    <div>
                        ...
                        <div className="flex justify-between w-full">
                            ...
                            <div className="bg-primary text-white p-1 rounded w-1/5 text-center">Tahap 1</div>
                        ...
                        <div>
                            <center>
                                <img className="w-1/5" src="/undraw_Happy_announcement_re_tsm0.png" alt="" srcset="" />
                                <h1 className="font-semibold">Selamat, Anda dinyatakan lolos tahap ini !</h1>
                                <p>
                                    Jangan bersenang dulu, dan segera persiapkan diri kamu <br />
                                    untuk tahap berikutnya !<br />
                                    Silahkan cek Email, Whatsapp dan Telegram<br />
                                    secara berkala untuk a lebih lanjut
                                </p>
                            </center>
                        </div>
                    </div>
