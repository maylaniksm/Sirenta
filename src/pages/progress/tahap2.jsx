                ...
                <div className="pr-5 py-8">
                    <div>
                        ...
                        <div className="flex justify-between w-full">
                            ...
                            <div className="bg-primary text-white p-1 rounded w-1/5 text-center">Tahap 2</div>
                            <div className="bg-bgLight p-1 rounded w-1/5 text-center">Tahap 3</div>
                        </div>
                        <div>
                            <center>
                                <img className="w-1/3" src="/wait.png" alt="" srcset="" />
                                <h1 className="font-semibold">Pengumuman</h1>
                                <p>
                                    Berikut Folder Tahap 3:<br />
                                    https://drive.google.com/drive/folders/1obIzZw-S3uBT6Wpnfkk5uMqyvwGVUyZm<br />
                                    Link Grup Tahap 3:<br />
                                    https://chat.whatsapp.com/JnYDsXzTtcJKWgEqzNaqqB<br />
                                    TAHAP 3 AKAN BERDURASI KURANG LEBIH 3 BULAN<br />
                                    Terdiri dari 3 kategori:<br />
                                    1. Workshop 2. Project 3. Magang<br />
                                </p>
                            </center>
                        </div>
                    </div>
