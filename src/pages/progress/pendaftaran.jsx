                            ...
                            <div className="w-1/2 pr-2">
                                ...
                                <div>
                                    ...
                                    <div className="flex justify-around w-full">
                                        <button className="p-2 rounded-lg border-solid border-2 border-primary">Laki-Laki</button>
                                        <button className="p-2 rounded-lg text-white bg-primary">Perempuan</button>
                                    </div>
                                </div>
                            </div>
                            <div className="w-1/2">
